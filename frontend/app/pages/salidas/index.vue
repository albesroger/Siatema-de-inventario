  ...
  <section class="space-y-3">
    ...
    <div class="grid gap-4 md:grid-cols-3">
      ...
      >
        ...
        <p class="text-xl font-bold text-slate-800">{{ totalSalidas }}</p>
      </div>
      ...
      >
        ...
        <p class="text-xl font-bold text-green-600">{{ salidasCompletadas }}</p>
      </div>
      ...
      >
        ...
        <p class="text-xl font-bold text-red-600">{{ salidasAnuladas }}</p>
      </div>
    </div>
