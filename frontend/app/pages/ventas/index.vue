  ...
  <section class="space-y-3">
    ...
    <div class="grid gap-4 md:grid-cols-4">
      ...
      >
        ...
        <p class="text-xl font-bold text-slate-800">{{ totalVentas }}</p>
      </div>
      ...
      >
        ...
        <p class="text-xl font-bold text-slate-800">{{ ventasCompletadas }}</p>
      </div>
      ...
      >
        ...
        <p class="text-xl font-bold text-red-600">{{ ventasAnuladas }}</p>
      </div>
